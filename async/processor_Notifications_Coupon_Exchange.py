...
from app.model import Notification, NotifitationType
...
# コントラクトの生成
cp_exchange_contract = Contract.get_contract('IbetCouponExchange', config.IBET_CP_EXCHANGE_CONTRACT_ADDRESS)
