...
# PUSH通知送信
def push_publish(notification_id, account_address, priority, blocknumber, message):
    ...
    def loop(self):
        ...
        try:
            ...
            for bond_token in bond_token_list:
                try:
                    # イベント取得
                    bond_contract = Contract.get_contract('IbetStraightBondExchange', bond_token[0])
