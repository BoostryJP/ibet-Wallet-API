...
class TestProcessor:
    ...
    def test_normal_1(
        ...
        # user1: 6000 trader: 44000(balance: 41000, locked: 3000)
        ...
        assert user1_record.locked == 0
        assert trader_record.hold_balance == 41000
        assert trader_record.locked == 3000
    ...
    def test_normal_2(
        ...
        bond_lock(self.trader, token, self.issuer["account_address"], 3000)
        # user1: 13000 trader: 17000(balance: 14000, locked: 3000)

        bond_unlock(self.issuer, token, self.trader["account_address"], self.user1["account_address"], 2000)
        # user1: 15000 trader: 15000(balance: 14000, locked: 1000)
        ...
        assert trader_record.locked == 1000
    ...
    def test_normal_4(
        ...
        # user1: 10000 trader: 40000(balance: 37000, locked: 3000)
