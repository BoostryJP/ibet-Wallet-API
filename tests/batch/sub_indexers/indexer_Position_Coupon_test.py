...
from batch.sub_indexers import indexer_Position_Coupon
from batch.sub_indexers.indexer_Position_Coupon import LOG, Processor
...
class TestProcessor:
    ...
    async def test_normal_4(
        ...
        IbetCouponTestHelper.consume_token(
            self.issuer["account_address"], token.address, 3000
        )
