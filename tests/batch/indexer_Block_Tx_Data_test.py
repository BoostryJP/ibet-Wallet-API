...
class TestProcessor:
    ...
    def test_normal_1(self, processor, session, caplog):
        ...
        tx_data = session.query(IDXTxData).order_by(IDXTxData.created).all()
    ...
    def test_normal_3_2(self, processor, session, caplog):
        ...
        tx_hash = token_contract.functions.\
            transfer(to_address, 1).\
            transact({'from': deployer, 'gas': 4000000})
        ...
        assert tx_data[1].hash == tx_hash.hex()
