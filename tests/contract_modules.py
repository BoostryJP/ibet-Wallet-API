...
def register_payment_gateway(invoker, payment_gateway):
    ...
    tx_hash = PaymentGatewayContract.functions.approve(
...
def issue_bond_token(invoker, attribute):
    ...
    TokenContract.functions.setTradableExchange(attribute["tradableExchange"]).transact(
...
def bond_transfer_to_exchange(invoker, bond_exchange, bond_token, amount):
    ...
    tx_hash = TokenContract.functions.transfer(
...
def transfer_bond_token(
    ...
    tx_hash = TokenContract.functions.transfer(to["account_address"], amount).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def bond_redeem(invoker, token):
    ...
    tx_hash = TokenContract.functions.changeToRedeemed().transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def bond_change_transferable(invoker, token, transferable):
    ...
    tx_hash = TokenContract.functions.setTransferable(transferable).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def bond_invalidate(invoker, token):
    ...
    TokenContract = Contract.get_contract("IbetStraightBond", token["address"])
    tx_hash = TokenContract.functions.setStatus(False).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def bond_untransferable(invoker, token):
    ...
    TokenContract = Contract.get_contract("IbetStraightBond", token["address"])
    tx_hash = TokenContract.functions.setTransferable(False).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def bond_apply_for_transfer(invoker, token, recipient, amount, application_data):
    ...
    TokenContract = Contract.get_contract("IbetStraightBond", token["address"])
    tx_hash = TokenContract.functions.applyForTransfer(
...
def bond_cancel_transfer(invoker, token, application_id, application_data):
    ...
    TokenContract = Contract.get_contract("IbetStraightBond", token["address"])
    tx_hash = TokenContract.functions.cancelTransfer(
...
def bond_approve_transfer(invoker, token, application_id, application_data):
    ...
    TokenContract = Contract.get_contract("IbetStraightBond", token["address"])
    tx_hash = TokenContract.functions.approveTransfer(
        application_id, application_data
    ).transact({"from": invoker["account_address"], "gas": 4000000})
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def bond_lock(invoker, token, lock_address: str, amount: int):
    ...
    TokenContract = Contract.get_contract("IbetStraightBond", token["address"])
    tx_hash = TokenContract.functions.lock(lock_address, amount, "").transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def bond_unlock(
    ...
    TokenContract = Contract.get_contract("IbetStraightBond", token["address"])
    tx_hash = TokenContract.functions.unlock(
        target, recipient, amount, data_str
    ).transact({"from": invoker["account_address"], "gas": 4000000})
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def bond_issue_from(
    ...
    TokenContract = Contract.get_contract("IbetStraightBond", token["address"])
    tx_hash = TokenContract.functions.issueFrom(target, lock_address, amount).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def bond_redeem_from(
    ...
    TokenContract = Contract.get_contract("IbetStraightBond", token["address"])
    tx_hash = TokenContract.functions.redeemFrom(
...
def bond_set_tradable_exchange(invoker, token, exchange_address: str):
    ...
    TokenContract = Contract.get_contract("IbetStraightBond", token["address"])
    tx_hash = TokenContract.functions.setTradableExchange(exchange_address).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def share_transfer_to_exchange(invoker, exchange, token, amount):
    ...
    tx_hash = TokenContract.functions.transfer(exchange["address"], amount).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def invalidate_share_token(invoker, token):
    ...
    tx_hash = ShareTokenContract.functions.setStatus(False).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def untransferable_share_token(invoker, token):
    web3.eth.default_account = invoker["account_address"]
    ShareTokenContract = Contract.get_contract("IbetShare", token["address"])
    tx_hash = ShareTokenContract.functions.setTransferable(False).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def transfer_coupon_token(invoker, coupon_token, to, value):
    ...
    tx_hash = coupon_contract.functions.transfer(to, value).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def invalidate_coupon_token(invoker, coupon_token):
    ...
    tx_hash = CouponTokenContract.functions.setStatus(False).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def untransferable_coupon_token(invoker, coupon_token):
    ...
    tx_hash = CouponTokenContract.functions.setTransferable(False).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def consume_coupon_token(invoker, coupon_token, value):
    ...
    tx_hash = CouponTokenContract.functions.consume(value).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def take_buy(invoker, exchange, order_id, amount):
    web3.eth.default_account = invoker["account_address"]
    ExchangeContract = Contract.get_contract("IbetExchange", exchange["address"])
    tx_hash = ExchangeContract.functions.executeOrder(order_id, amount, True).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def take_sell(invoker, exchange, order_id, amount):
    web3.eth.default_account = invoker["account_address"]
    ExchangeContract = Contract.get_contract("IbetExchange", exchange["address"])
    tx_hash = ExchangeContract.functions.executeOrder(order_id, amount, False).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def cancel_order(invoker, exchange, order_id):
    web3.eth.default_account = invoker["account_address"]
    ExchangeContract = Contract.get_contract("IbetExchange", exchange["address"])
    tx_hash = ExchangeContract.functions.cancelOrder(order_id).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def force_cancel_order(invoker, exchange, order_id):
    web3.eth.default_account = invoker["account_address"]
    ExchangeContract = Contract.get_contract("IbetExchange", exchange["address"])
    tx_hash = ExchangeContract.functions.forceCancelOrder(order_id).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def confirm_agreement(invoker, exchange, order_id, agreement_id):
    web3.eth.default_account = invoker["account_address"]
    ExchangeContract = Contract.get_contract("IbetExchange", exchange["address"])
    tx_hash = ExchangeContract.functions.confirmAgreement(
...
def cancel_agreement(invoker, exchange, order_id, agreement_id):
    web3.eth.default_account = invoker["account_address"]
    ExchangeContract = Contract.get_contract("IbetExchange", exchange["address"])
    tx_hash = ExchangeContract.functions.cancelAgreement(
        order_id, agreement_id
    ).transact({"from": invoker["account_address"], "gas": 4000000})
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def create_security_token_escrow(
    ...
    tx_hash = IbetSecurityTokenEscrowContract.functions.createEscrow(
...
def cancel_security_token_escrow(invoker, exchange, escrow_id):
    ...
    tx_hash = IbetSecurityTokenEscrowContract.functions.cancelEscrow(
        escrow_id
    ).transact({"from": invoker["account_address"], "gas": 4000000})
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def approve_transfer_security_token_escrow(
    ...
    tx_hash = IbetSecurityTokenEscrowContract.functions.approveTransfer(
...
def finish_security_token_escrow(invoker, exchange, escrow_id):
    ...
    tx_hash = IbetSecurityTokenEscrowContract.functions.finishEscrow(
        escrow_id
    ).transact({"from": invoker["account_address"], "gas": 4000000})
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def create_token_escrow(
    ...
    tx_hash = IbetEscrow.functions.createEscrow(
        token["address"], recipient_address, amount, agent_address, "{}"
    ).transact({"from": invoker["account_address"], "gas": 4000000})
    web3.eth.wait_for_transaction_receipt(tx_hash)
...
def finish_token_escrow(invoker, exchange, escrow_id):
    web3.eth.default_account = invoker["account_address"]
    IbetEscrow = Contract.get_contract("IbetEscrow", exchange["address"])
    tx_hash = IbetEscrow.functions.finishEscrow(escrow_id).transact(
        {"from": invoker["account_address"], "gas": 4000000}
    )
    web3.eth.wait_for_transaction_receipt(tx_hash)
