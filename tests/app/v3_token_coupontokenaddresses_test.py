...
class TestV3TokenCouponTokenAddresses:
    """
    Test Case for v3.token.CouponTokenAddresses
    """

    # テスト対象API
    apiurl = "/v3/Token/Coupon/Address"
    ...
    def test_error_1(self, client, session, shared_contract, processor: Processor):
        ...
        assert resp.json["meta"] == {
            "code": 10,
            "description": "method: GET, url: /v3/Token/Coupon/Address",
