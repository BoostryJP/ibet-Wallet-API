...
class TestV3TokenMembershipTokenAddresses:
    """
    Test Case for v3.token.MembershipTokenAddresses
    """

    # テスト対象API
    apiurl = "/v3/Token/Membership/Address"
    ...
    def test_error_1(self, client, session, shared_contract, processor: Processor):
        ...
        assert resp.json["meta"] == {
            "code": 10,
            "description": "method: GET, url: /v3/Token/Membership/Address",
