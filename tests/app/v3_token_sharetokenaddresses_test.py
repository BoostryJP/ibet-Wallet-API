...
class TestV3TokenShareTokenAddresses:
    """
    Test Case for v3.token.ShareTokenAddresses
    """

    # テスト対象API
    apiurl = "/v3/Token/Share/Address"
    ...
    def test_error_1(self, client, session, shared_contract, processor: Processor):
        ...
        assert resp.json["meta"] == {
            "code": 10,
            "description": "method: GET, url: /v3/Token/Share/Address",
