...
class TestTokenTokenStatus:
    ...
    def test_tokenstatus_normal_1(self, client: TestClient, session: Session, shared_contract):
        ...
        attribute = TestTokenTokenStatus.bond_token_attribute(exchange_address, personal_info)
    ...
    def test_tokenstatus_normal_4(self, client: TestClient, session: Session, shared_contract):
        ...
        personal_info = to_checksum_address(shared_contract['PersonalInfo']['address'])
        attribute = TestTokenTokenStatus.share_token_attribute(exchange_address, personal_info)
