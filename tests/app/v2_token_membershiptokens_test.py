...
class TestV2TokenMembershipTokens:
    ...
    # HTTPメソッド不正
    # -> 404エラー
    def test_membershiplist_error_1(self, client, session):
        config.MEMBERSHIP_TOKEN_ENABLED = True
    ...
    # cursorに文字が含まれる
    # -> 入力エラー
    def test_membershiplist_error_2_1(self, client, session):
        config.MEMBERSHIP_TOKEN_ENABLED = True
    ...
    # cursorが負値
    # -> 入力エラー
    def test_membershiplist_error_2_2(self, client, session):
        config.MEMBERSHIP_TOKEN_ENABLED = True
        query_string = 'cursor=-1&limit=1'
        resp = client.simulate_get(self.apiurl, query_string=query_string)
    ...
    # cursorが小数
    # -> 入力エラー
    def test_membershiplist_error_2_3(self, client, session):
        config.MEMBERSHIP_TOKEN_ENABLED = True
    ...
    # cursorがint最大値
    # -> 入力エラー
    def test_membershiplist_error_2_4(self, client, session):
        config.MEMBERSHIP_TOKEN_ENABLED = True
    ...
    # limitに文字が含まれる
    # -> 入力エラー
    def test_membershiplist_error_3_1(self, client, session):
        config.MEMBERSHIP_TOKEN_ENABLED = True
    ...
    # limitが負値
    # -> 入力エラー
    def test_membershiplist_error_3_2(self, client, session):
        config.MEMBERSHIP_TOKEN_ENABLED = True
        query_string = 'cursor=1&limit=-1'
        resp = client.simulate_get(self.apiurl, query_string=query_string)
    ...
    # limitが小数
    # -> 入力エラー
    def test_membershiplist_error_3_3(self, client, session):
        config.MEMBERSHIP_TOKEN_ENABLED = True
    ...
    def test_error_4(self, client, session):
        ...
        assert resp.json['meta'] == {
            'code': 10,
            'message': 'Not Supported',
            'description': 'method: GET, url: /v2/Token/Membership'
        }
