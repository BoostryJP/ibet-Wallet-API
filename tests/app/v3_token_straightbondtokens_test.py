...
class TestV3TokenStraightBondTokens:
    """
    Test Case for v3.token.StraightBondTokens
    """

    # テスト対象API
    apiurl = "/v3/Token/StraightBond"
    ...
    def test_error_1(self, client, session, shared_contract, processor: Processor):
        ...
        assert resp.json["meta"] == {
            "code": 10,
            "description": "method: GET, url: /v3/Token/StraightBond",
