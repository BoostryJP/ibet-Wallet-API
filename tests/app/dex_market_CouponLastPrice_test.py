...
class TestDEXMarketCouponLastPrice:
    ...
    #  -> 現在値：0円
    def test_coupon_lastprice_normal_1(self, client: TestClient, session: Session):
    ...
    #  -> 現在値：0円
    def test_coupon_lastprice_normal_2(self, client: TestClient, session: Session, shared_contract):
    ...
    # 正常系3：1000円で約定
    #  -> 現在値1000円が返却される
    def test_coupon_lastprice_normal_3(self, client: TestClient, session: Session, shared_contract):
        exchange = shared_contract['IbetCouponExchange']
    ...
    def test_coupon_lastprice_error_1(self, client: TestClient, session: Session):
        headers = {'Content-Type': 'application/json'}
    ...
    def test_coupon_lastprice_error_3(self, client: TestClient, session: Session):
    ...
    # エラー系4：HTTPメソッドが不正
    def test_coupon_lastprice_error_4(self, client: TestClient, session: Session):
    ...
    # エラー系5：取扱トークン対象外
    def test_coupon_lastprice_error_5(self, client: TestClient, session: Session):
        token_address = "0xe883a6f441ad5682d37df31d34fc012bcb07a740"
        request_params = {"address_list": [token_address]}
        request_body = json.dumps(request_params)
    ...
    def test_coupon_lastprice_error_6(self, client: TestClient, session: Session):
        token_address = "0xe883a6f441ad5682d37df31d34fc012bcb07a740"
        request_params = {"address_list": [token_address]}
        request_body = json.dumps(request_params)
