...
class TestDEXMarketCouponTick:
    ...
    def _insert_test_data(self, session: Session):
        ...
        a.amount = 3
        a.status = 1
        a.settlement_timestamp = datetime.strptime(
            "2019-11-13 16:23:14.183706", "%Y-%m-%d %H:%M:%S.%f"
        )
        a.created = datetime.strptime(
            "2019-11-13 16:26:14.183706", "%Y-%m-%d %H:%M:%S.%f"
        )
        session.add(a)
        ...
        a.status = 1
        a.settlement_timestamp = datetime.strptime(
            "2019-11-13 16:24:14.183706", "%Y-%m-%d %H:%M:%S.%f"
        )
        a.created = datetime.strptime(
            "2019-11-13 16:26:14.183706", "%Y-%m-%d %H:%M:%S.%f"
        )
