...
class TestSearchTokenTransferApprovalHistory:
    """
    Test Case for token.SearchTokenTransferApprovalHistory
    """
    ...
    # offset=設定なし、 limit=設定なし
    def test_normal_2_9(self, client: TestClient, session: Session):
        # prepare data
        listing = {
            "token_address": self.token_address,
            "is_public": True,
    ...
    # offset=設定なし、 limit=設定なし
    def test_normal_2_10(self, client: TestClient, session: Session):
        # prepare data
        listing = {
            "token_address": self.token_address,
            "is_public": True,
