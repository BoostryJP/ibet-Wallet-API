...
class TestPositionAccountAddressCouponContractAddress:
    # Test API
    apiurl = "/v3/Position/{account_address}/Coupon/{contract_address}"
    ...
    def create_balance_data(account, exchange_contract, token_list_contract):
        ...
        token = issue_coupon_token(TestPositionAccountAddressCouponContractAddress.issuer, args)
        coupon_register_list(TestPositionAccountAddressCouponContractAddress.issuer, token, token_list_contract)
        transfer_coupon_token(
            TestPositionAccountAddressCouponContractAddress.issuer,
            token,
    ...
    def create_commitment_data(account, exchange_contract, token_list_contract, commitment):
        # Issue token
        token = TestPositionAccountAddressCouponContractAddress.create_balance_data(
    ...
    def test_error_1(self, client, session):
        ...
        # Request target API
        router_obj = client.app._router_search("/v3/Position/{account_address}/Coupon/{contract_address}")[0]
        ...
        assert resp.json["meta"] == {
            ...
            "description": f"method: GET, url: /v3/Position/{account_address}/Coupon/{contract_address}"
        }
