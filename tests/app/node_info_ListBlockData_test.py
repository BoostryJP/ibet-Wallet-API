...
class TestListBlockData:
    ...
    @staticmethod
    def insert_block_data(session: Session, block_data: dict[str, Any]) -> None:
        block_model = IDXBlockData()
        block_model.number = block_data["number"]
        block_model.parent_hash = block_data["parent_hash"]
        ...
        block_model.hash = block_data["hash"]
    ...
    def test_normal_3_2(self, client: TestClient, session: Session):
        ...
        assert response_data["block_data"] == [self.filter_response_item(self.block_0)]
    ...
    def test_error_1(self, client: TestClient, session: Session):
        ...
        assert resp.json()["meta"] == {
            ...
            "description": "method: GET, url: /NodeInfo/BlockData",
        }
