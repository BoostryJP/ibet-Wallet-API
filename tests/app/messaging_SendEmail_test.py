...
class TestSendEmail:
    ...
    def test_normal_1_3(self, client: TestClient, session: Session):
        ...
        assert mail.text_content == "text content"
        assert mail.html_content == "<p>html content</p>"
        assert mail.file_name == "test_data.pdf"
        assert (
            mail.file_content
            == b""
        )
    ...
    def test_normal_3(self, client: TestClient, session: Session):
        failed_mail = Mail()
        failed_mail.to_email = "failed@example.com"
        failed_mail.subject = "Failed email"
        failed_mail.text_content = "text content"
        failed_mail.html_content = "<p>html content</p>"
        failed_mail.status = MailStatus.FAILED
        session.add(failed_mail)
    ...
    def test_normal_5(self, client: TestClient, session: Session):
        ...
        resp = client.post(
            "/Mail/Resend",
            json={"mail_ids": [mail.id for mail in mail_list]},
        )
