...
class TestPositionAccountAddressShareContractAddress:
    # Test API
    apiurl = "/v3/Position/{account_address}/Share/{contract_address}"
    ...
    def test_error_1(self, client, session):
        ...
        # Request target API
        router_obj = client.app._router_search("/v3/Position/{account_address}/Share/{contract_address}")[0]
        ...
        assert resp.json["meta"] == {
            ...
            "description": f"method: GET, url: /v3/Position/{account_address}/Share/{contract_address}"
        }
