...
class TestDEXMarketStraightBondOrderBook:
    ...
    #
    # -> リスト1件が返却
    def test_orderbook_normal_1_1_1(self, client: TestClient, session: Session):
    ...
    #
    # -> リスト1件が返却
    def test_orderbook_normal_1_1_2(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #
    # -> ゼロ件リストが返却
    def test_orderbook_normal_1_2(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #
    # -> ゼロ件リストが返却
    def test_orderbook_normal_1_3(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #
    # -> ゼロ件リストが返却
    def test_orderbook_normal_1_4(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    # 未約定＆未キャンセルの売り注文が1件存在
    # 限界値
    def test_orderbook_normal_1_5(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #
    # -> ゼロ件リストが返却
    def test_orderbook_normal_1_6(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #
    # -> リスト1件が返却
    def test_orderbook_normal_2_1_1(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #
    # -> リスト1件が返却
    def test_orderbook_normal_2_1_2(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #
    # -> ゼロ件リストが返却
    def test_orderbook_normal_2_2(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #
    # -> ゼロ件リストが返却
    def test_orderbook_normal_2_3(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #
    # -> ゼロ件リストが返却
    def test_orderbook_normal_2_4(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    # 未約定＆未キャンセルの買い注文が1件存在
    # 限界値
    def test_orderbook_normal_2_5(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #
    # -> ゼロ件リストが返却
    def test_orderbook_normal_2_6(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    # -> リストのソート順が価格の昇順
    def test_orderbook_normal_3_1(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    # -> リストのソート順が価格の降順
    def test_orderbook_normal_3_2(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    def test_orderbook_normal_4_1(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #  -> 未約定のOrderBookリストが返却される
    def test_orderbook_normal_4_2(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #  -> 未約定のOrderBookリストが返却される
    def test_orderbook_normal_4_3(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #  -> 未約定のOrderBookリストが返却される
    def test_orderbook_normal_4_4(self, client: TestClient, session: Session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    def test_orderbook_error_1(self, client: TestClient, session: Session):
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
        config.IBET_SB_EXCHANGE_CONTRACT_ADDRESS = exchange_address
    ...
    def test_orderbook_error_3_1(self, client: TestClient, session: Session):
    ...
    def test_orderbook_error_3_2(self, client: TestClient, session: Session):
    ...
    def test_orderbook_error_4_1(self, client: TestClient, session: Session):
        token_address = "0xe883a6f441ad5682d37df31d34fc012bcb07a740"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    def test_orderbook_error_4_2(self, client: TestClient, session: Session):
        token_address = "0xe883a6f441ad5682d37df31d34fc012bcb07a740"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    def test_orderbook_error_5(self, client: TestClient, session: Session):
        token_address = "0xe883a6f441ad5682d37df31d34fc012bcb07a740"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    # エラー系6：HTTPメソッドが不正
    def test_orderbook_error_6(self, client: TestClient, session: Session):
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
        config.IBET_SB_EXCHANGE_CONTRACT_ADDRESS = exchange_address
        ...
        assert resp.json()['meta'] == {
            'code': 1,
            'description': 'method: GET, url: /DEX/Market/OrderBook/StraightBond',
            'message': 'Method Not Allowed'
        }

    # エラー系7：取扱トークン対象外
    def test_orderbook_error_7(self, client: TestClient, session: Session):
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        ...
        assert resp.json()['meta'] == {
            ...
            'description': 'method: POST, url: /DEX/Market/OrderBook/StraightBond'
        }

    # エラー系8：exchangeアドレス未設定
    def test_orderbook_error_8(self, client: TestClient, session: Session):
        config.BOND_TOKEN_ENABLED = True
