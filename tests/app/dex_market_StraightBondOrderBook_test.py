...
class TestDEXMarketStraightBondOrderBook:
    ...
    def test_orderbook_normal_4_1(self, client, session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #  -> 未約定のOrderBookリストが返却される
    def test_orderbook_normal_4_2(self, client, session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #  -> 未約定のOrderBookリストが返却される
    def test_orderbook_normal_4_3(self, client, session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    #  -> 未約定のOrderBookリストが返却される
    def test_orderbook_normal_4_4(self, client, session):
        token_address = "0x4814B3b0b7aC56097F280B254F8A909A76ca7f51"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    def test_orderbook_error_1(self, client, session):
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
        config.IBET_SB_EXCHANGE_CONTRACT_ADDRESS = exchange_address
    ...
    def test_orderbook_error_2(self, client, session):
    ...
    def test_orderbook_error_3_1(self, client, session):
    ...
    def test_orderbook_error_3_2(self, client, session):
    ...
    def test_orderbook_error_4_1(self, client, session):
        token_address = "0xe883a6f441ad5682d37df31d34fc012bcb07a740"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    def test_orderbook_error_4_2(self, client, session):
        token_address = "0xe883a6f441ad5682d37df31d34fc012bcb07a740"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    def test_orderbook_error_5(self, client, session):
        token_address = "0xe883a6f441ad5682d37df31d34fc012bcb07a740"
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
    ...
    # エラー系6：HTTPメソッドが不正
    def test_orderbook_error_6(self, client, session):
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
        config.BOND_TOKEN_ENABLED = True
        config.IBET_SB_EXCHANGE_CONTRACT_ADDRESS = exchange_address
    ...
    # エラー系7：取扱トークン対象外
    def test_orderbook_error_7(self, client, session):
        exchange_address = \
            to_checksum_address("0x6f427cf02d749267300252658490b3c3ac579eac")
    ...
    def test_orderbook_error_8(self, client, session):
        config.BOND_TOKEN_ENABLED = True
