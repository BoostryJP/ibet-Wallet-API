...
class TestPositionStraightBondContractAddress:
    ...
    def test_normal_4(self, client: TestClient, session: Session, shared_contract):
        ...
        self.create_idx_token(session, token_3["address"], personal_info_contract["address"], exchange_contract["address"])

        token_4 = self.create_commitment_data(
            self.account_1, exchange_contract, personal_info_contract, token_list_contract, 1000000)
        self.create_idx_position(session, token_4["address"], self.account_1, exchange_commitment=1000000)
        self.list_token(token_4["address"], session)
        self.create_idx_token(session, token_4["address"], personal_info_contract["address"], exchange_contract["address"])
