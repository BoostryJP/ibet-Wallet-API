...
function start () {
    ...
    gunicorn -b 0.0.0.0:5000 --reload app.main:app --timeout 30 --workers=$WORKER_COUNT --max-requests 500 --max-requests-jitter 200 --limit-request-line 0 -k uvicorn.workers.UvicornWorker
}
