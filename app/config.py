...
# - Refresh Token: OAuth2 Refresh Token (acquired with offline_access and SMTP.Send scopes)
SMTP_MS_REFRESH_TOKEN: str | None = os.environ.get("SMTP_MS_REFRESH_TOKEN")
