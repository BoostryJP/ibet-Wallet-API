    ...
    def get_StraightBond_OrderList(session, account_address, company_list, available_tokens):
        ...
        for (id, order_id) in entries:
            ...
            if orderBook[2] != 0:
                ...
                bondtoken.payment_method_credit_card = available_token.payment_method_credit_card if hasattr(
                    available_token, "payment_method_credit_card") else False
                bondtoken.payment_method_bank = available_token.payment_method_bank if hasattr(available_token,
                                                                                               "payment_method_bank") else False
    ...
    def get_Membership_OrderList(session, account_address, company_list, available_tokens):
        ...
        for (id, order_id) in entries:
            ...
            if orderBook[2] != 0:
                ...
                membershiptoken.payment_method_credit_card = available_token.payment_method_credit_card if hasattr(
                    available_token, "payment_method_credit_card") else False
                membershiptoken.payment_method_bank = available_token.payment_method_bank if hasattr(available_token,
                                                                                                     "payment_method_bank") else False
    ...
    def get_Coupon_OrderList(session, account_address, company_list, available_tokens):
        ...
        for (id, order_id) in entries:
            ...
            if orderBook[2] != 0:
                ...
                coupontoken.payment_method_credit_card = available_token.payment_method_credit_card if hasattr(
                    available_token, "payment_method_credit_card") else False
                coupontoken.payment_method_bank = available_token.payment_method_bank if hasattr(available_token,
                                                                                                 "payment_method_bank") else False
