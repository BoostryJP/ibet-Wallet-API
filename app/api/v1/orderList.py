...
class OrderList(BaseResource):
    ...
    def on_post(self, req, res):
        ...
        for account_address in request_json['account_address_list']:
            # 普通社債トークン
            order_list.extend(
                OrderList.get_StraightBond_OrderList(account_address, company_list))
        ...
        for account_address in request_json['account_address_list']:
            ...
            settlement_list.extend(
                OrderList.get_StraightBond_SettlementList_Buy(account_address, company_list))

            # 普通社債トークン（売）
            settlement_list.extend(
                OrderList.get_StraightBond_SettlementList_Sell(account_address, company_list))

            # 会員権トークン（買）
            settlement_list.extend(
                OrderList.get_Membership_SettlementList_Buy(account_address, company_list))
        ...
        for account_address in request_json['account_address_list']:
            ...
            complete_list.extend(
                OrderList.get_StraightBond_CompleteList_Buy(account_address, company_list))

            # 普通社債トークン（売）
            complete_list.extend(
                OrderList.get_StraightBond_CompleteList_Sell(account_address, company_list))

            # 会員権トークン（買）
            complete_list.extend(
                OrderList.get_Membership_CompleteList_Buy(account_address, company_list))
    ...
    # 注文一覧：普通社債トークン
    @staticmethod
    def get_StraightBond_OrderList(account_address, company_list):
        # Exchange Contract
    ...
    # 注文一覧：会員権トークン
    @staticmethod
    def get_Membership_OrderList(account_address, company_list):
        # Exchange Contract
        ExchangeContract = Contract.get_contract(
    ...
    # 決済中一覧：普通社債トークン（買）
    @staticmethod
    def get_StraightBond_SettlementList_Buy(account_address, company_list):
        # Exchange Contract
        ExchangeContract = Contract.get_contract(
            'IbetStraightBondExchange',
            os.environ.get('IBET_SB_EXCHANGE_CONTRACT_ADDRESS')
    ...
    # 決済中一覧：普通社債トークン（売）
    @staticmethod
    def get_StraightBond_SettlementList_Sell(account_address, company_list):
        # Exchange Contract
        ExchangeContract = Contract.get_contract(
            'IbetStraightBondExchange',
            os.environ.get('IBET_SB_EXCHANGE_CONTRACT_ADDRESS')
    ...
    # 決済中一覧：会員権トークン（買）
    @staticmethod
    def get_Membership_SettlementList_Buy(account_address, company_list):
        # Exchange Contract
        ExchangeContract = Contract.get_contract(
            'IbetMembershipExchange',
            os.environ.get('IBET_MEMBERSHIP_EXCHANGE_CONTRACT_ADDRESS')
    ...
    # 決済中一覧：会員権トークン（売）
    @staticmethod
    def get_Membership_SettlementList_Sell(account_address, company_list):
        # Exchange Contract
        ExchangeContract = Contract.get_contract(
            'IbetMembershipExchange',
            os.environ.get('IBET_MEMBERSHIP_EXCHANGE_CONTRACT_ADDRESS')
    ...
    # 約定済一覧：普通社債トークン（売）
    @staticmethod
    def get_StraightBond_CompleteList_Sell(account_address, company_list):
        # Exchange Contract
        ExchangeContract = Contract.get_contract(
            'IbetStraightBondExchange',
            os.environ.get('IBET_SB_EXCHANGE_CONTRACT_ADDRESS')
    ...
    # 約定済一覧：会員権トークン（買）
    @staticmethod
    def get_Membership_CompleteList_Buy(account_address, company_list):
        # Exchange Contract
        ExchangeContract = Contract.get_contract(
            'IbetMembershipExchange',
            os.environ.get('IBET_MEMBERSHIP_EXCHANGE_CONTRACT_ADDRESS')
    ...
    # 約定済一覧：会員権トークン（売）
    @staticmethod
    def get_Membership_CompleteList_Sell(account_address, company_list):
        # Exchange Contract
        ExchangeContract = Contract.get_contract(
            'IbetMembershipExchange',
            os.environ.get('IBET_MEMBERSHIP_EXCHANGE_CONTRACT_ADDRESS')
