...
class TestPositionAccountAddressMembershipContractAddress:
    # Test API
    apiurl = "/v3/Position/{account_address}/Membership/{contract_address}"
    ...
    def create_balance_data(account, exchange_contract, token_list_contract):
        ...
        token = membership_issue(TestPositionAccountAddressMembershipContractAddress.issuer, args)
        membership_register_list(TestPositionAccountAddressMembershipContractAddress.issuer, token, token_list_contract)
        membership_transfer_to_exchange(
            TestPositionAccountAddressMembershipContractAddress.issuer,
    ...
    def create_commitment_data(account, exchange_contract, token_list_contract, commitment):
        # Issue token
        token = TestPositionAccountAddressMembershipContractAddress.create_balance_data(
        ...
        ExchangeContract = Contract.get_contract(
            'IbetMembershipExchange', exchange_contract['address'])
    ...
    def test_error_1(self, client, session):
        ...
        # Request target API
        router_obj = client.app._router_search("/v3/Position/{account_address}/Membership/{contract_address}")[0]
        ...
        assert resp.json["meta"] == {
            ...
            "description": f"method: GET, url: /v3/Position/{account_address}/Membership/{contract_address}"
        }
