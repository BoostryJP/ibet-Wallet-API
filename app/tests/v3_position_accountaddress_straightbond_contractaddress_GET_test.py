...
from app.tests.utils import PersonalInfoUtils
...
class TestPositionAccountAddressStraightBondContractAddress:
    # Test API
    apiurl = "/v3/Position/{account_address}/StraightBond/{contract_address}"
    ...
    def create_balance_data(account, exchange_contract,
        ...
        issuer_address = TestPositionAccountAddressStraightBondContractAddress.issuer["account_address"]
        ...
        token = issue_bond_token(TestPositionAccountAddressStraightBondContractAddress.issuer, args)
        register_bond_list(TestPositionAccountAddressStraightBondContractAddress.issuer, token, token_list_contract)
        ...
        bond_transfer_to_exchange(
            TestPositionAccountAddressStraightBondContractAddress.issuer,
    ...
    def test_error_1(self, client, session):
        ...
        # Request target API
        router_obj = client.app._router_search("/v3/Position/{account_address}/StraightBond/{contract_address}")[0]
        ...
        assert resp.json["meta"] == {
            ...
            "description": f"method: GET, url: /v3/Position/{account_address}/StraightBond/{contract_address}"
        }
