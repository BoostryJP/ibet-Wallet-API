...
class TestV2TokenShareTokenAddresses:
    """
    Test Case for v2.token.ShareTokenAddresses
    """

    # テスト対象API
    apiurl = '/v2/Token/Share/Address'
    ...
    def test_normal_1(self, client, session, shared_contract):
        ...
        # TokenListコントラクト
        token_list = TestV2TokenShareTokenAddresses.tokenlist_contract()
        ...
        # 取扱トークンデータ挿入
        TestV2TokenShareTokenAddresses.list_token(session, share_token)
    ...
    def test_sharelist_error_1(self, client):
        ...
        assert resp.json['meta'] == {
            ...
            'description': 'method: POST, url: /v2/Token/Share/Address'
        }
    ...
    def test_sharelist_error_4(self, client):
        ...
        assert resp.json['meta'] == {
            'code': 10,
            'message': 'Not Supported',
            'description': 'method: GET, url: /v2/Token/Share/Address'
        }
