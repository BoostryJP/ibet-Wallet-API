...
class TestV2TokenStraightBondTokenStatus:
    """
    Test Case for v2.token.StraightBondTokenStatus
    """

    # テスト対象API
    apiurl_base = '/v2/Token/StraightBond/{contract_address}/Status'
    ...
    def test_straightbondstatus_normal_1(self, client, session, shared_contract):
        ...
        # TokenListコントラクト
        token_list = TestV2TokenStraightBondTokenStatus.tokenlist_contract()
        ...
        attribute = TestV2TokenStraightBondTokenStatus.bond_token_attribute(exchange_address, personal_info)
        bond_token = issue_bond_token(issuer, attribute)
        register_bond_list(issuer, bond_token, token_list)

        # 取扱トークンデータ挿入
        TestV2TokenStraightBondTokenStatus.list_token(session, bond_token)
    ...
    def test_straightbondstatus_normal_2(self, client, session, shared_contract):
        ...
        # 取扱トークンデータ挿入
        TestV2TokenStraightBondTokenStatus.list_token(session, token)
