...
class TestV1StripeCreateAccount():
    ...
    def test_stripe_create_account_error_1_4(self, client, session):
        request_params = {
            'account_address': self.default_account_address,
            'account_token': "abc"
        }
    ...
    def test_stripe_create_account_error_2_1(self, client, session):
        request_params = {
    ...
    # エラー系2-2
    # account_addressの値が空
    def test_stripe_create_account_error_2_2(self, client, session):
        request_params = {
            'account_address': "",
            'account_token': "ct_1EPLU9HgQLLPjBO2760HyH5v"
        }
    ...
    def test_stripe_create_account_error_2_3(self, client, session):
        request_params = {
    ...
    def test_stripe_create_account_error_2_4(self, client, session):
        request_params = {
